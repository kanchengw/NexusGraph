...
class Settings:
    ...
    def __init__(self):
        ...
        # Embedding Configuration (DashScope)
        self.EMBEDDING_MODEL = os.getenv("EMBEDDING_MODEL", "text-embedding-v3")
        self.EMBEDDING_BASE_URL = os.getenv("EMBEDDING_BASE_URL", "https://dashscope.aliyuncs.com/compatible-mode/v1")
        ...
        self.GRAPHRAG_CHUNK_SIZE = int(os.getenv("GRAPHRAG_CHUNK_SIZE", "512"))
        self.GRAPHRAG_CHUNK_OVERLAP = int(os.getenv("GRAPHRAG_CHUNK_OVERLAP", "64"))
        self.GRAPHRAG_TOP_K = int(os.getenv("GRAPHRAG_TOP_K", "5"))
        self.GRAPHRAG_VECTOR_INDEX_NAME = os.getenv("GRAPHRAG_VECTOR_INDEX_NAME", "rag_chunks")

        # Evaluation Configuration
        self.EVALUATION_LLM = os.getenv("EVALUATION_LLM", self.DEFAULT_LLM_MODEL)
        self.EVALUATION_BASE_URL = os.getenv("EVALUATION_BASE_URL", self.LLM_BASE_URL)
